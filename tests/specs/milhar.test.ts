...
describe("números inteiros com quatro ou cinco casas", function () {
  ...
  describe("utilizando o próprio algoritimo", function () {
    it("número 1000", async function () {
      ...
      try {
        resposta = await axios.get("/v2/1000");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número 8300", async function () {
      ...
      try {
        resposta = await axios.get("/v2/8300");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número -31937", async function () {
      ...
      try {
        resposta = await axios.get("/v2/-31937");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número 50000", async function () {
      ...
      try {
        resposta = await axios.get("/v2/50000");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número -70000", async function () {
      ...
      try {
        resposta = await axios.get("/v2/-70000");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número 99999", async function () {
      ...
      try {
        resposta = await axios.get("/v2/99999");
      } catch (error) {
        resposta = error.response;
      }
