...
describe("números inteiros com duas casas", function () {
  ...
  describe("utilizando o próprio algoritimo", function () {
    it("número -10", async function () {
      ...
      try {
        resposta = await axios.get("/v2/-10");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número -99", async function () {
      ...
      try {
        resposta = await axios.get("/v2/-99");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número 20", async function () {
      ...
      try {
        resposta = await axios.get("/v2/20");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número 53", async function () {
      ...
      try {
        resposta = await axios.get("/v2/53");
      } catch (error) {
        resposta = error.response;
      }
    ...
    it("número 47", async function () {
      ...
      try {
        resposta = await axios.get("/v2/47");
      } catch (error) {
        resposta = error.response;
      }
